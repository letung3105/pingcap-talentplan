...
criterion_group! {
    ...
    targets = write_many_compare_engines, read_many_compare_engines,
}
...
pub fn write_many_compare_engines(c: &mut Criterion) {
...
pub fn read_many_compare_engines(c: &mut Criterion) {
